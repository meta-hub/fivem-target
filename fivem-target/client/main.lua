...
exports('AddTargetPoint',function(opts) 
  if not opts or not opts.name or not opts.label or not opts.point or not opts.options then return end
...
exports('AddTargetModel',function(opts) 
  if not opts or not opts.name or not opts.label or not opts.model or not opts.options then return end
  table.insert(allTargets,{
    typeof        = "model",
    name          = opts.name,
    label         = opts.label,
...
exports('AddTargetModels',function(opts) 
  if not opts or not opts.name or not opts.label or not opts.models or not opts.options then return end
  table.insert(allTargets,{
    typeof        = "model",
    name          = opts.name,
    label         = opts.label,
...
exports('AddPolyZone',function(opts)
  if not opts or not opts.name or not opts.label or not opts.getInside or not opts.options then return end
  table.insert(allTargets,{
    typeof        = "polyzone",
    name          = opts.name,
    label         = opts.label,
    icon          = opts.icon or "fas fa-question",
    getInside     = opts.getInside,
    onInteract    = opts.onInteract,
    options       = opts.options,
    vars          = opts.vars,
    resource      = GetInvokingResource()
